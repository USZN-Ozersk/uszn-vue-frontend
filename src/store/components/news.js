...
export default {
    ...
    actions: {
          loadFirstNews: (context) => {                                                 // Действие для загрузки и мутации массива элементов новостей главной страницы
            axios
              .get('http://45.84.225.234:81/api/v1/news/first/5')
              .then(response => {
          ...
          loadOneNews: (context, id) => {                                   // Действие для загрузки и мутации единичной новости
            axios
              .get('http://45.84.225.234:81/api/v1/news/single/'+id)
              .then(response => {
          ...
          loadNewsPage: (context, id) => {
            axios
              .get('http://45.84.225.234:81/api/v1/news/page/'+(id-1))
              .then(response => {
          ...
          loadNewsCount: (context) => {
            axios
              .get('http://45.84.225.234:81/api/v1/news/count/all')
              .then(response => {
